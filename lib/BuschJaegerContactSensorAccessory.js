...
class BuschJaegerContactSensorAccessory extends BuschJaegerAccessory {
    ...
    getContactSensorState(callback) {
        let detected = parseInt(this.getValue(this.channel, 'odp0000')) == 1 ? this.Characteristic.ContactSensorState.CONTACT_DETECTED : this.Characteristic.ContactSensorState.CONTACT_NOT_DETECTED
