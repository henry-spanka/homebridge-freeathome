                ...
                if (update['channel'] == channel && update['datapoint'] == datapoint) {
                    if (update['value'] === null) {
                        ...
                        if (error) {
                            ...
                            this.platform.log("If this issue persists please try to login as the API user in the free@home UI. This must sometimes be done after a reboot to enable websocket notifications.");
